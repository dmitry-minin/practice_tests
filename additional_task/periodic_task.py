...
if __name__ == "__main__":
    periodic_task = PeriodicTask('Купить огурцы', 'Купить огурцы для салата', '01.04.2024', '01.01.2024',
                                 run_time=60)
    ...
    periodic_task2 = PeriodicTask('Купить огурцы', 'Купить огурцы для салата', '01.04.2024', '01.01.2024',
                                 run_time=60)
